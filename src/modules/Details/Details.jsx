	...
	return (
		<div className='details'>
			<div className='details__container'>
				<Text size='l' color='yellow' titleFont>ДЕТАЛИ ТОРЖЕСТВА</Text>
				...
				<Line/>
				<Text marginTop={30}>
					Мы  хотим чтобы каждый в полной мере насладился праздником, поэтому обращаем Ваше внимание, что ждем гостей возраста 18+
				</Text>
			</div>
		</div>
	)
